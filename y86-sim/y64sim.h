...
/* Y64 Instruction */
typedef enum { I_HALT = 0, I_NOP, I_RRMOVQ, I_IRMOVQ, I_RMMOVQ, I_MRMOVQ, I_ALU, I_JMP, I_CALL, I_RET, I_PUSHQ, I_POPQ, I_DIRECTIVE } itype_t;

/* Function code (default) */
typedef enum { F_0, F_1, F_2, F_3, F_4, F_5, F_6 } func_t;

/* ALU code */
typedef enum { A_ADD, A_SUB, A_AND, A_XOR, A_FOO, A_BAR, A_BAZ } alu_t;
